...
class Entity:
    ...
    def move_astar(self, target, entities, game_map):
        ...
        # The path size matters if you want the monster to use alternative longer paths (for example
        # through other rooms) if for example the player is in a corridor
